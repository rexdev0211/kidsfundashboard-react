...
const ClubResourceView: FC = () => {
  ...
  const [view, setView] = useState<CalendarView>(
    mobileDevice ? 'listWeek' : 'resourceTimeGridDay'
  )
  ...
  useEffect(() => {
    ...
    if (calendarEl) {
      ...
      const newView = mobileDevice ? 'listWeek' : 'resourceTimeGridDay'
...
export default ClubResourceView
